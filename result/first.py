...
pipe_knn2= Pipeline([('knn2_minMax02',minMax02),('knn2_pca55',pca55) ,('clf_knn', KNeighborsClassifier())])
...
distribution_rndForest1_param={"clf__max_depth": [5, null],"clf__min_samples_split": sp_randint(2,11),"clf__max_features": sp_randint(1,11),"clf__min_samples_leaf": sp_randint(1,11),"clf__bootstrap": [true, false],"clf__criterion": [gini, entropy] }
